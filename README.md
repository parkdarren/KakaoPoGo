...
| `/추첨` | 오늘 채팅한 사람 중 최근 7일 상품 수령 등록자를 제외하고 추첨 |
...
방 운영 설정에서 `최근 7일 채팅량 가중치 적용`을 켜면 오늘 활동한 후보들의 최근
7일 채팅량이 당첨 확률에 반영됩니다. 활동량이 많을수록 유리하지만 가중치 상한과
기본 확률을 함께 적용해 활동량이 적은 사람에게도 당첨 가능성이 남습니다. 설정은
방마다 따로 저장되며 기본값은 꺼짐입니다.
